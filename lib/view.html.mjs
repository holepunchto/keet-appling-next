...
export default html`
  ...
  <script>
    ...
    const STAGE_MESSAGES = ['Installing platform...', 'Platform installed, installing app...']
    ...
    function setProgress({ speed, peers, progress, stage }) {
      // Update stats
      ...
      if (stage !== undefined && STAGE_MESSAGES[stage]) {
        elements.warning.textContent = STAGE_MESSAGES[stage]
