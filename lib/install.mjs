...
import { App, Screen, Window, WebView, Image } from 'fx-native'
...
export async function install(id, opts = {}) {
  ...
  app
    .on('launch', () => {
      ...
      const bar = new Image(0, 0, WINDOW_WIDTH, DRAG_BAR_HEIGHT)
      const bg = new Uint8Array([10, 51, 66, 255]) // #0a3342 in RGBA
      bar.loadPixels(bg, 1, 1)

      view = new WebView(0, DRAG_BAR_HEIGHT, WINDOW_WIDTH, WINDOW_HEIGHT - DRAG_BAR_HEIGHT)
